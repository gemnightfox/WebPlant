(function () {
    ...
    var verificationSentUrl = form.dataset.verificationSentUrl;
    ...
    function startLoadingBtn() {
        ...
        dotInterval = setInterval(function () {
            dots = (dots + 1) % 4;
            submitBtn.textContent = 'Creating your account' + '.'.repeat(dots);
        }, 400);
    }
    ...
    form.addEventListener('submit', function (e) {
        ...
        fetch(form.action, {
            ...
            // allauth returns a 3xx redirect on success; fetch sees it as opaqueredirect
            if (response.type === 'opaqueredirect') {
                window.location.href = verificationSentUrl;
                return;
            }
            ...
            return response.text().then(function (html) {
                ...
                ['username', 'email', 'password1'].forEach(function (name) {
