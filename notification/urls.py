...
urlpatterns = [
    ...
    path('temp-disable/<user_pk>/<token>/', temp_disable, name='temp_disable'), # Used when user clicks the link found below every email sent (temporarily disables notifications)
